...
root.buttons(awful.util.table.join(
	...
	-- Volume
	awful.button({ modkey }, 4, function() awful.util.spawn("amixer set Master 9%+", false) end),
	awful.button({ modkey }, 5, function() awful.util.spawn("amixer set Master 9%-", false) end)
))
-- }}}
