...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "Tab",
        ...
        {description = "cycle backward", group = "client"}),
...
--            {description = "decrease master width factor", group = "layout"}),
    ...
    awful.key({ modkey }, "i",    function() awful.util.spawn("amixer set PCM 9%+", false) end,
              {description = "increase control PCM by 9%", group = "custom"}),
    awful.key({ modkey }, "Up",   function() awful.util.spawn("amixer set PCM 9%+", false) end,
              {description = "increase control PCM by 9%", group = "custom"}),
    awful.key({ }, "XF86AudioRaiseVolume",   function() awful.util.spawn("amixer set PCM 9%+", false) end,
              {description = "increase control PCM by 9%", group = "custom"}),
    awful.key({ modkey }, "u",    function() awful.util.spawn("amixer set PCM 9%-", false) end,
              {description = "decrease control PCM by 9%", group = "custom"}),
    awful.key({ modkey }, "Down", function() awful.util.spawn("amixer set PCM 9%-", false) end,
              {description = "decrease control PCM by 9%", group = "custom"}),
    awful.key({ }, "XF86AudioLowerVolume", function() awful.util.spawn("amixer set PCM 9%-", false) end,
              {description = "decrease control PCM by 9%", group = "custom"}),
    awful.key({ modkey }, "[", function() awful.util.spawn("amixer set PCM toggle", false) end,
              {description = "mute control PCM", group = "custom"}),
